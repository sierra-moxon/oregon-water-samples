# Contributing to oregon-water-samples

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
oregon-water-samples. These guidelines are not strict rules.
...
The oregon-water-samples team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the oregon-water-samples technical leads
...
[issues]: https://github.com/sierra-moxon/oregon-water-samples/issues/
[pulls]: https://github.com/sierra-moxon/oregon-water-samples/pulls/
